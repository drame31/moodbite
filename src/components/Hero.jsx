      ...
      <div className="max-w-content mx-auto px-6 flex flex-col lg:flex-row items-start gap-12">
        ...
        <div className="lg:w-3/5">
          ...
          <motion.p
            ...
            className="font-mono text-xs text-ink-muted dark:text-parchment-muted uppercase tracking-wider mb-4"
          >
        ...
        {/* Right column — 40% — decorative chip cluster */}
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
